...
| 工具 | 分类 | 渲染组件 | 埋点 | 接口 | 备注 |
|---|---|---|---|---|---|
| `pdf-to-jpg` | pdf | FileUploadTool | ✅ | ✅ 正常 |  |
| `jpg-to-pdf` | pdf | FileUploadTool | ✅ | ✅ 正常 |  |
| `merge-pdf` | pdf | MergePdfTool | ✅ | ✅ 正常 |  |
| `split-pdf` | pdf | SplitPdfTool | ✅ | ✅ 正常 |  |
| `png-to-jpg` | image | FileUploadTool | ✅ | ✅ 正常 |  |
| `svg-to-png` | image | FileUploadTool | ✅ | 纯前端 |  |
| `png-to-svg` | image | FileUploadTool | ✅ | ✅ 正常 |  |
| `barcode-reader` | barcode | FileUploadTool | ✅ | ✅ 正常 |  |
| `barcode-qr-decoder` | barcode | FileUploadTool | ✅ | ✅ 正常 |  |
| `dns` | network | NetworkTool | ✅ | ✅ 正常 |  |
| `whois` | network | NetworkTool | ✅ | ✅ 正常 |  |
| `asn` | network | NetworkTool | ✅ | ✅ 正常 |  |
| `http-header` | network | NetworkTool | ✅ | ✅ 正常 |  |
| `mx-checker` | email | EmailDiagnosticsTool | ✅ | ✅ 正常 |  |
| `dkim-checker` | email | EmailDiagnosticsTool | ✅ | ✅ 正常 |  |
| `dmarc-checker` | email | EmailDiagnosticsTool | ✅ | ✅ 正常 |  |
| `tls-handshake-test` | email | EmailDiagnosticsTool | ✅ | ✅ 正常 |  |
| `dnsbl-checker` | email | EmailDiagnosticsTool | ✅ | ✅ 正常 |  |
| `ptr-lookup` | email | EmailDiagnosticsTool | ✅ | ✅ 正常 |  |
| `email-diagnostics` | email | EmailDiagnosticsTool | ✅ | ✅ 正常 |  |
...
| `to-mp4` | video | VideoConverterTool | ✅ | ✅ 正常 |  |
| `wifi-password-generator` | password | GeneratorTool | ✅ | 纯前端 |  |
| `exif-auto-orient` | image | FileUploadTool | ✅ | ✅ 正常 |  |
...
| `ip-blocktest` | network | IpBlockTestTool | ✅ | ✅ 正常 |  |
