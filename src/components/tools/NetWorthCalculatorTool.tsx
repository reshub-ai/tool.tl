...
export default function NetWorthCalculatorTool({ slug, locale }: Props) {
  ...
  return (
    <div>
      <div className="tl-auto-stack" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap:'1rem', marginBottom:'1rem' }}>
        {/* 资产 */}
        <div style={card}>
      ...
      <div className="tl-auto-stack" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(100%, 200px), 1fr))', gap:'0.75rem', marginBottom:'1rem' }}>
        {[
